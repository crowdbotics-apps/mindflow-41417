"""
Django settings for mindflow_41417 project.
...
ROOT_URLCONF = 'mindflow_41417.urls'
...
WSGI_APPLICATION = 'mindflow_41417.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mindflow_41417 API",
    "DESCRIPTION": "API documentation for mindflow_41417 App",
    "VERSION": "v1",
}
